<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode( '[contact-form-7 id="155" title="Форма вопросов"]' );?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('social_instagram', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('social_facebook', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('social_youtube', 2)?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('phone_number_1', 2) ?>"><?php the_field('phone_number_1', 2) ?></a>
                            ...
                            <div class="footer__contacts-item">
                                ...
                                <address><?php the_field('street', 2) ?></address>
                            </div>
                        </div>
                    </div>
                </div>
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDCm02_8ow9vZ7H3VvchSC8DTlx1L2p3F8"></script>
