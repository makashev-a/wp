        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <?php the_field('contacts_descr', 2)?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="contacts__map">
                    <?php echo do_shortcode( '[yamap center="55.7381,37.5074" height="100%" controls="zoomControl" zoom="16" type="yandex#map" scrollzoom="0"][yaplacemark  name="Мы здесь!" coord="55.73795157576787,37.50694979629515" icon="islands#dotIcon" color="#1e98ff"][/yamap]' ); ?>								
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    ...
                    <?php echo do_shortcode( '[contact-form-7 id="154" title="Форма отзыва"]' ); ?>
